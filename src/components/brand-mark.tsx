...
export function BrandMark({ className = "", size = 40 }: BrandMarkProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" aria-hidden="true" className={className}>
      ...
      <path d="M16 45.5L24 48.4" stroke="url(#safeLogoRoad)" strokeWidth="4" strokeLinecap="round" />
      <path d="M24.5 50L33.5 56" stroke="url(#safeLogoRoad)" strokeWidth="4" strokeLinecap="round" />
      <path d="M42 39.4C46.4 39.9 50 42.9 52 47.2" stroke="url(#safeLogoRoad)" strokeWidth="5" strokeLinecap="round" />
      <path d="M31.6 18C28.1 22.7 28.1 28.5 31.6 33.2C35.1 28.5 35.1 22.7 31.6 18Z" fill="#ea580c" />
      <circle cx="31.6" cy="22" r="2.8" fill="#ffffff" />
      <path d="M20 48.8C24.7 49.2 29.7 52 33.6 56.2" stroke="#ea580c" strokeWidth="5" strokeLinecap="round" />
    </svg>
  );
}